...
class RSSForm(forms.Form):
    ...
    receipt = forms.FileField(label='Receipt', widget=forms.ClearableFileInput(attrs={'class':'file-path validate','placeholder':'Upload a Photo/Screenshot of Your Receipt', 'type':'text'}), label_suffix='', required=False)
