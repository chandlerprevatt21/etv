...
def ct_list(request):
    ...
    filtered_qs = f.qs
    beauty = filtered_qs.filter(category='beauty')
    books = filtered_qs.filter(category='books')
    cars = filtered_qs.filter(category='cars')
    child = filtered_qs.filter(category='child')
    cleaning = filtered_qs.filter(category='cleaning')
    clothing = filtered_qs.filter(category='clothing')
    construction = filtered_qs.filter(category='construction')
    education = filtered_qs.filter(category='education')
    eldercare = filtered_qs.filter(category='eldercare')
    electronics = filtered_qs.filter(category='electronics')
    entertainment = filtered_qs.filter(category='entertainment')
    farming = filtered_qs.filter(category='farming')
    florists = filtered_qs.filter(category='florists')
    grocery = filtered_qs.filter(category='grocery')
    health = filtered_qs.filter(category='health')
    home = filtered_qs.filter(category='home')
    hotels = filtered_qs.filter(category='hotels')
    jewelry = filtered_qs.filter(category='jewelry')
    legal = filtered_qs.filter(category='legal')
    lifestyle = filtered_qs.filter(category='lifestyle')
    marketing = filtered_qs.filter(category='marketing')
    medical = filtered_qs.filter(category='medical')
    other = filtered_qs.filter(category='other')
    packaging = filtered_qs.filter(category='packaging')
    pets = filtered_qs.filter(category='pets')
    photography = filtered_qs.filter(category='photography')
    professional = filtered_qs.filter(category='professional')
    realestate = filtered_qs.filter(category='real estate')
    recreation = filtered_qs.filter(category='recreation')
    restaurants = filtered_qs.filter(category='restaurants')
    security = filtered_qs.filter(category='security')
    transportation = filtered_qs.filter(category='transportation')
    visual = filtered_qs.filter(category='visual')
    ...
    paginator_construction = Paginator(construction, 8)
...
def getStateListings(request):
    ...
    if state == 'US-CT':
        ...
        beauty = list(vbp_ct.objects.filter(category='beauty'))
        books = list(vbp_ct.objects.filter(category='books'))
        cars = list(vbp_ct.objects.filter(category='cars'))
        child = list(vbp_ct.objects.filter(category='child'))
        cleaning = list(vbp_ct.objects.filter(category='cleaning'))
        clothing = list(vbp_ct.objects.filter(category='clothing'))
        construction = list(vbp_ct.objects.filter(category='construction'))
        education = list(vbp_ct.objects.filter(category='education'))
        eldercare = list(vbp_ct.objects.filter(category='eldercare'))
        electronics = list(vbp_ct.objects.filter(category='electronics'))
        entertainment = list(vbp_ct.objects.filter(category='entertainment'))
        farming = list(vbp_ct.objects.filter(category='farming'))
        florists = list(vbp_ct.objects.filter(category='florists'))
        grocery = list(vbp_ct.objects.filter(category='grocery'))
        health = list(vbp_ct.objects.filter(category='health'))
        home = list(vbp_ct.objects.filter(category='home'))
        hotels = list(vbp_ct.objects.filter(category='hotels'))
        jewelry = list(vbp_ct.objects.filter(category='jewelry'))
        legal = list(vbp_ct.objects.filter(category='legal'))
        lifestyle = list(vbp_ct.objects.filter(category='lifestyle'))
        marketing = list(vbp_ct.objects.filter(category='marketing'))
        medical = list(vbp_ct.objects.filter(category='medical'))
        other = list(vbp_ct.objects.filter(category='other'))
        packaging = list(vbp_ct.objects.filter(category='packaging'))
        pets = list(vbp_ct.objects.filter(category='pets'))
        photography = list(vbp_ct.objects.filter(category='photography'))
        professional = list(vbp_ct.objects.filter(category='professional'))
        realestate = list(vbp_ct.objects.filter(category='real estate'))
        recreation = list(vbp_ct.objects.filter(category='recreation'))
        restaurants = list(vbp_ct.objects.filter(category='restaurants'))
        security = list(vbp_ct.objects.filter(category='security'))
        transportation = list(vbp_ct.objects.filter(category='transportation'))
        visual = list(vbp_ct.objects.filter(category='visual'))
    ...
    if state == 'US-DE':
        ...
        beauty = list(vbp_de.objects.filter(category='beauty'))
        books = list(vbp_de.objects.filter(category='books'))
        cars = list(vbp_de.objects.filter(category='cars'))
        child = list(vbp_de.objects.filter(category='child'))
        cleaning = list(vbp_de.objects.filter(category='cleaning'))
        clothing = list(vbp_de.objects.filter(category='clothing'))
        construction = list(vbp_de.objects.filter(category='construction'))
        education = list(vbp_de.objects.filter(category='education'))
        eldercare = list(vbp_de.objects.filter(category='eldercare'))
        electronics = list(vbp_de.objects.filter(category='electronics'))
        entertainment = list(vbp_de.objects.filter(category='entertainment'))
        farming = list(vbp_de.objects.filter(category='farming'))
        florists = list(vbp_de.objects.filter(category='florists'))
        grocery = list(vbp_de.objects.filter(category='grocery'))
        health = list(vbp_de.objects.filter(category='health'))
        home = list(vbp_de.objects.filter(category='home'))
        hotels = list(vbp_de.objects.filter(category='hotels'))
        jewelry = list(vbp_de.objects.filter(category='jewelry'))
        legal = list(vbp_de.objects.filter(category='legal'))
        lifestyle = list(vbp_de.objects.filter(category='lifestyle'))
        marketing = list(vbp_de.objects.filter(category='marketing'))
        medical = list(vbp_de.objects.filter(category='medical'))
        other = list(vbp_de.objects.filter(category='other'))
        packaging = list(vbp_de.objects.filter(category='packaging'))
        pets = list(vbp_de.objects.filter(category='pets'))
        photography = list(vbp_de.objects.filter(category='photography'))
        professional = list(vbp_de.objects.filter(category='professional'))
        realestate = list(vbp_de.objects.filter(category='real estate'))
        recreation = list(vbp_de.objects.filter(category='recreation'))
        restaurants = list(vbp_de.objects.filter(category='restaurants'))
        security = list(vbp_de.objects.filter(category='security'))
        transportation = list(vbp_de.objects.filter(category='transportation'))
        visual = list(vbp_de.objects.filter(category='visual'))

        paginator_beauty = Paginator(beauty, 22)
        paginator_books = Paginator(books, 22)
        paginator_cars = Paginator(cars, 22)
        paginator_child = Paginator(child,22)
        paginator_cleaning = Paginator(cleaning, 10)
        paginator_clothing = Paginator(clothing, 22)
        paginator_construction = Paginator(construction, 10)
        paginator_education = Paginator(education, 22)
        paginator_eldercare = Paginator(eldercare, 22)
        paginator_electronics = Paginator(electronics, 22)
        paginator_entertainment = Paginator(entertainment, 22)
    ...
    if state == 'US-DC':
        ...
        beauty = list(vbp_dc.objects.filter(category='beauty'))
        books = list(vbp_dc.objects.filter(category='books'))
        cars = list(vbp_dc.objects.filter(category='cars'))
        child = list(vbp_dc.objects.filter(category='child'))
        cleaning = list(vbp_dc.objects.filter(category='cleaning'))
        clothing = list(vbp_dc.objects.filter(category='clothing'))
        construction = list(vbp_dc.objects.filter(category='construction'))
        education = list(vbp_dc.objects.filter(category='education'))
        eldercare = list(vbp_dc.objects.filter(category='eldercare'))
        electronics = list(vbp_dc.objects.filter(category='electronics'))
        entertainment = list(vbp_dc.objects.filter(category='entertainment'))
        farming = list(vbp_dc.objects.filter(category='farming'))
        florists = list(vbp_dc.objects.filter(category='florists'))
        grocery = list(vbp_dc.objects.filter(category='grocery'))
        health = list(vbp_dc.objects.filter(category='health'))
        home = list(vbp_dc.objects.filter(category='home'))
        hotels = list(vbp_dc.objects.filter(category='hotels'))
        jewelry = list(vbp_dc.objects.filter(category='jewelry'))
        legal = list(vbp_dc.objects.filter(category='legal'))
        lifestyle = list(vbp_dc.objects.filter(category='lifestyle'))
        marketing = list(vbp_dc.objects.filter(category='marketing'))
        medical = list(vbp_dc.objects.filter(category='medical'))
        other = list(vbp_dc.objects.filter(category='other'))
        packaging = list(vbp_dc.objects.filter(category='packaging'))
        pets = list(vbp_dc.objects.filter(category='pets'))
        photography = list(vbp_dc.objects.filter(category='photography'))
        professional = list(vbp_dc.objects.filter(category='professional'))
        realestate = list(vbp_dc.objects.filter(category='real estate'))
        recreation = list(vbp_dc.objects.filter(category='recreation'))
        restaurants = list(vbp_dc.objects.filter(category='restaurants'))
        security = list(vbp_dc.objects.filter(category='security'))
        transportation = list(vbp_dc.objects.filter(category='transportation'))
        visual = list(vbp_dc.objects.filter(category='visual'))
    ...
    if state == 'US-MD':
        ...
        beauty = list(vbp_md.objects.filter(category='beauty'))
        books = list(vbp_md.objects.filter(category='books'))
        cars = list(vbp_md.objects.filter(category='cars'))
        child = list(vbp_md.objects.filter(category='child'))
        cleaning = list(vbp_md.objects.filter(category='cleaning'))
        clothing = list(vbp_md.objects.filter(category='clothing'))
        construction = list(vbp_md.objects.filter(category='construction'))
        education = list(vbp_md.objects.filter(category='education'))
        eldercare = list(vbp_md.objects.filter(category='eldercare'))
        electronics = list(vbp_md.objects.filter(category='electronics'))
        entertainment = list(vbp_md.objects.filter(category='entertainment'))
        farming = list(vbp_md.objects.filter(category='farming'))
        florists = list(vbp_md.objects.filter(category='florists'))
        grocery = list(vbp_md.objects.filter(category='grocery'))
        health = list(vbp_md.objects.filter(category='health'))
        home = list(vbp_md.objects.filter(category='home'))
        hotels = list(vbp_md.objects.filter(category='hotels'))
        jewelry = list(vbp_md.objects.filter(category='jewelry'))
        legal = list(vbp_md.objects.filter(category='legal'))
        lifestyle = list(vbp_md.objects.filter(category='lifestyle'))
        marketing = list(vbp_md.objects.filter(category='marketing'))
        medical = list(vbp_md.objects.filter(category='medical'))
        other = list(vbp_md.objects.filter(category='other'))
        packaging = list(vbp_md.objects.filter(category='packaging'))
        pets = list(vbp_md.objects.filter(category='pets'))
        photography = list(vbp_md.objects.filter(category='photography'))
        professional = list(vbp_md.objects.filter(category='professional'))
        realestate = list(vbp_md.objects.filter(category='real estate'))
        recreation = list(vbp_md.objects.filter(category='recreation'))
        restaurants = list(vbp_md.objects.filter(category='restaurants'))
        security = list(vbp_md.objects.filter(category='security'))
        transportation = list(vbp_md.objects.filter(category='transportation'))
        visual = list(vbp_md.objects.filter(category='visual'))
    ...
    if state == 'US-MA':
        ...
        beauty = list(vbp_ma.objects.filter(category='beauty'))
        books = list(vbp_ma.objects.filter(category='books'))
        cars = list(vbp_ma.objects.filter(category='cars'))
        child = list(vbp_ma.objects.filter(category='child'))
        cleaning = list(vbp_ma.objects.filter(category='cleaning'))
        clothing = list(vbp_ma.objects.filter(category='clothing'))
        construction = list(vbp_ma.objects.filter(category='construction'))
        education = list(vbp_ma.objects.filter(category='education'))
        eldercare = list(vbp_ma.objects.filter(category='eldercare'))
        electronics = list(vbp_ma.objects.filter(category='electronics'))
        entertainment = list(vbp_ma.objects.filter(category='entertainment'))
        farming = list(vbp_ma.objects.filter(category='farming'))
        florists = list(vbp_ma.objects.filter(category='florists'))
        grocery = list(vbp_ma.objects.filter(category='grocery'))
        health = list(vbp_ma.objects.filter(category='health'))
        home = list(vbp_ma.objects.filter(category='home'))
        hotels = list(vbp_ma.objects.filter(category='hotels'))
        jewelry = list(vbp_ma.objects.filter(category='jewelry'))
        legal = list(vbp_ma.objects.filter(category='legal'))
        lifestyle = list(vbp_ma.objects.filter(category='lifestyle'))
        marketing = list(vbp_ma.objects.filter(category='marketing'))
        medical = list(vbp_ma.objects.filter(category='medical'))
        other = list(vbp_ma.objects.filter(category='other'))
        packaging = list(vbp_ma.objects.filter(category='packaging'))
        pets = list(vbp_ma.objects.filter(category='pets'))
        photography = list(vbp_ma.objects.filter(category='photography'))
        professional = list(vbp_ma.objects.filter(category='professional'))
        realestate = list(vbp_ma.objects.filter(category='real estate'))
        recreation = list(vbp_ma.objects.filter(category='recreation'))
        restaurants = list(vbp_ma.objects.filter(category='restaurants'))
        security = list(vbp_ma.objects.filter(category='security'))
        transportation = list(vbp_ma.objects.filter(category='transportation'))
        visual = list(vbp_ma.objects.filter(category='visual'))
    ...
    if state == 'US-NJ':
        ...
        beauty = list(vbp_nj.objects.filter(category='beauty'))
        books = list(vbp_nj.objects.filter(category='books'))
        cars = list(vbp_nj.objects.filter(category='cars'))
        child = list(vbp_nj.objects.filter(category='child'))
        cleaning = list(vbp_nj.objects.filter(category='cleaning'))
        clothing = list(vbp_nj.objects.filter(category='clothing'))
        construction = list(vbp_nj.objects.filter(category='construction'))
        education = list(vbp_nj.objects.filter(category='education'))
        eldercare = list(vbp_nj.objects.filter(category='eldercare'))
        electronics = list(vbp_nj.objects.filter(category='electronics'))
        entertainment = list(vbp_nj.objects.filter(category='entertainment'))
        farming = list(vbp_nj.objects.filter(category='farming'))
        florists = list(vbp_nj.objects.filter(category='florists'))
        grocery = list(vbp_nj.objects.filter(category='grocery'))
        health = list(vbp_nj.objects.filter(category='health'))
        home = list(vbp_nj.objects.filter(category='home'))
        hotels = list(vbp_nj.objects.filter(category='hotels'))
        jewelry = list(vbp_nj.objects.filter(category='jewelry'))
        legal = list(vbp_nj.objects.filter(category='legal'))
        lifestyle = list(vbp_nj.objects.filter(category='lifestyle'))
        marketing = list(vbp_nj.objects.filter(category='marketing'))
        medical = list(vbp_nj.objects.filter(category='medical'))
        other = list(vbp_nj.objects.filter(category='other'))
        packaging = list(vbp_nj.objects.filter(category='packaging'))
        pets = list(vbp_nj.objects.filter(category='pets'))
        photography = list(vbp_nj.objects.filter(category='photography'))
        professional = list(vbp_nj.objects.filter(category='professional'))
        realestate = list(vbp_nj.objects.filter(category='real estate'))
        recreation = list(vbp_nj.objects.filter(category='recreation'))
        restaurants = list(vbp_nj.objects.filter(category='restaurants'))
        security = list(vbp_nj.objects.filter(category='security'))
        transportation = list(vbp_nj.objects.filter(category='transportation'))
        visual = list(vbp_nj.objects.filter(category='visual'))
    ...
    if state == 'US-NY':
        ...
        beauty = list(vbp_ny.objects.filter(category='beauty'))
        books = list(vbp_ny.objects.filter(category='books'))
        cars = list(vbp_ny.objects.filter(category='cars'))
        child = list(vbp_ny.objects.filter(category='child'))
        cleaning = list(vbp_ny.objects.filter(category='cleaning'))
        clothing = list(vbp_ny.objects.filter(category='clothing'))
        construction = list(vbp_ny.objects.filter(category='construction'))
        education = list(vbp_ny.objects.filter(category='education'))
        eldercare = list(vbp_ny.objects.filter(category='eldercare'))
        electronics = list(vbp_ny.objects.filter(category='electronics'))
        entertainment = list(vbp_ny.objects.filter(category='entertainment'))
        farming = list(vbp_ny.objects.filter(category='farming'))
        florists = list(vbp_ny.objects.filter(category='florists'))
        grocery = list(vbp_ny.objects.filter(category='grocery'))
        health = list(vbp_ny.objects.filter(category='health'))
        home = list(vbp_ny.objects.filter(category='home'))
        hotels = list(vbp_ny.objects.filter(category='hotels'))
        jewelry = list(vbp_ny.objects.filter(category='jewelry'))
        legal = list(vbp_ny.objects.filter(category='legal'))
        lifestyle = list(vbp_ny.objects.filter(category='lifestyle'))
        marketing = list(vbp_ny.objects.filter(category='marketing'))
        medical = list(vbp_ny.objects.filter(category='medical'))
        other = list(vbp_ny.objects.filter(category='other'))
        packaging = list(vbp_ny.objects.filter(category='packaging'))
        pets = list(vbp_ny.objects.filter(category='pets'))
        photography = list(vbp_ny.objects.filter(category='photography'))
        professional = list(vbp_ny.objects.filter(category='professional'))
        realestate = list(vbp_ny.objects.filter(category='real estate'))
        recreation = list(vbp_ny.objects.filter(category='recreation'))
        restaurants = list(vbp_ny.objects.filter(category='restaurants'))
        security = list(vbp_ny.objects.filter(category='security'))
        transportation = list(vbp_ny.objects.filter(category='transportation'))
        visual = list(vbp_ny.objects.filter(category='visual'))
    ...
    if state == 'US-OH':
        ...
        beauty = list(vbp_oh.objects.filter(category='beauty'))
        books = list(vbp_oh.objects.filter(category='books'))
        cars = list(vbp_oh.objects.filter(category='cars'))
        child = list(vbp_oh.objects.filter(category='child'))
        cleaning = list(vbp_oh.objects.filter(category='cleaning'))
        clothing = list(vbp_oh.objects.filter(category='clothing'))
        construction = list(vbp_oh.objects.filter(category='construction'))
        education = list(vbp_oh.objects.filter(category='education'))
        eldercare = list(vbp_oh.objects.filter(category='eldercare'))
        electronics = list(vbp_oh.objects.filter(category='electronics'))
        entertainment = list(vbp_oh.objects.filter(category='entertainment'))
        farming = list(vbp_oh.objects.filter(category='farming'))
        florists = list(vbp_oh.objects.filter(category='florists'))
        grocery = list(vbp_oh.objects.filter(category='grocery'))
        health = list(vbp_oh.objects.filter(category='health'))
        home = list(vbp_oh.objects.filter(category='home'))
        hotels = list(vbp_oh.objects.filter(category='hotels'))
        jewelry = list(vbp_oh.objects.filter(category='jewelry'))
        legal = list(vbp_oh.objects.filter(category='legal'))
        lifestyle = list(vbp_oh.objects.filter(category='lifestyle'))
        marketing = list(vbp_oh.objects.filter(category='marketing'))
        medical = list(vbp_oh.objects.filter(category='medical'))
        other = list(vbp_oh.objects.filter(category='other'))
        packaging = list(vbp_oh.objects.filter(category='packaging'))
        pets = list(vbp_oh.objects.filter(category='pets'))
        photography = list(vbp_oh.objects.filter(category='photography'))
        professional = list(vbp_oh.objects.filter(category='professional'))
        realestate = list(vbp_oh.objects.filter(category='real estate'))
        recreation = list(vbp_oh.objects.filter(category='recreation'))
        restaurants = list(vbp_oh.objects.filter(category='restaurants'))
        security = list(vbp_oh.objects.filter(category='security'))
        transportation = list(vbp_oh.objects.filter(category='transportation'))
        visual = list(vbp_oh.objects.filter(category='visual'))
    ...
    if state == 'US-PA':
        ...
        beauty = list(vbp_pa.objects.filter(category='beauty'))
        books = list(vbp_pa.objects.filter(category='books'))
        cars = list(vbp_pa.objects.filter(category='cars'))
        child = list(vbp_pa.objects.filter(category='child'))
        cleaning = list(vbp_pa.objects.filter(category='cleaning'))
        clothing = list(vbp_pa.objects.filter(category='clothing'))
        construction = list(vbp_pa.objects.filter(category='construction'))
        education = list(vbp_pa.objects.filter(category='education'))
        eldercare = list(vbp_pa.objects.filter(category='eldercare'))
        electronics = list(vbp_pa.objects.filter(category='electronics'))
        entertainment = list(vbp_pa.objects.filter(category='entertainment'))
        farming = list(vbp_pa.objects.filter(category='farming'))
        florists = list(vbp_pa.objects.filter(category='florists'))
        grocery = list(vbp_pa.objects.filter(category='grocery'))
        health = list(vbp_pa.objects.filter(category='health'))
        home = list(vbp_pa.objects.filter(category='home'))
        hotels = list(vbp_pa.objects.filter(category='hotels'))
        jewelry = list(vbp_pa.objects.filter(category='jewelry'))
        legal = list(vbp_pa.objects.filter(category='legal'))
        lifestyle = list(vbp_pa.objects.filter(category='lifestyle'))
        marketing = list(vbp_pa.objects.filter(category='marketing'))
        medical = list(vbp_pa.objects.filter(category='medical'))
        other = list(vbp_pa.objects.filter(category='other'))
        packaging = list(vbp_pa.objects.filter(category='packaging'))
        pets = list(vbp_pa.objects.filter(category='pets'))
        photography = list(vbp_pa.objects.filter(category='photography'))
        professional = list(vbp_pa.objects.filter(category='professional'))
        realestate = list(vbp_pa.objects.filter(category='real estate'))
        recreation = list(vbp_pa.objects.filter(category='recreation'))
        restaurants = list(vbp_pa.objects.filter(category='restaurants'))
        security = list(vbp_pa.objects.filter(category='security'))
        transportation = list(vbp_pa.objects.filter(category='transportation'))
        visual = list(vbp_pa.objects.filter(category='visual'))
    ...
    if state == 'US-VA':
        ...
        beauty = list(vbp_va.objects.filter(category='beauty'))
        books = list(vbp_va.objects.filter(category='books'))
        cars = list(vbp_va.objects.filter(category='cars'))
        child = list(vbp_va.objects.filter(category='child'))
        cleaning = list(vbp_va.objects.filter(category='cleaning'))
        clothing = list(vbp_va.objects.filter(category='clothing'))
        construction = list(vbp_va.objects.filter(category='construction'))
        education = list(vbp_va.objects.filter(category='education'))
        eldercare = list(vbp_va.objects.filter(category='eldercare'))
        electronics = list(vbp_va.objects.filter(category='electronics'))
        entertainment = list(vbp_va.objects.filter(category='entertainment'))
        farming = list(vbp_va.objects.filter(category='farming'))
        florists = list(vbp_va.objects.filter(category='florists'))
        grocery = list(vbp_va.objects.filter(category='grocery'))
        health = list(vbp_va.objects.filter(category='health'))
        home = list(vbp_va.objects.filter(category='home'))
        hotels = list(vbp_va.objects.filter(category='hotels'))
        jewelry = list(vbp_va.objects.filter(category='jewelry'))
        legal = list(vbp_va.objects.filter(category='legal'))
        lifestyle = list(vbp_va.objects.filter(category='lifestyle'))
        marketing = list(vbp_va.objects.filter(category='marketing'))
        medical = list(vbp_va.objects.filter(category='medical'))
        other = list(vbp_va.objects.filter(category='other'))
        packaging = list(vbp_va.objects.filter(category='packaging'))
        pets = list(vbp_va.objects.filter(category='pets'))
        photography = list(vbp_va.objects.filter(category='photography'))
        professional = list(vbp_va.objects.filter(category='professional'))
        realestate = list(vbp_va.objects.filter(category='real estate'))
        recreation = list(vbp_va.objects.filter(category='recreation'))
        restaurants = list(vbp_va.objects.filter(category='restaurants'))
        security = list(vbp_va.objects.filter(category='security'))
        transportation = list(vbp_va.objects.filter(category='transportation'))
        visual = list(vbp_va.objects.filter(category='visual'))
