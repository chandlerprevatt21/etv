...
def ct_list(request):
    ...
    paginator_construction = Paginator(construction, 20)
    ...
    paginator_medical = Paginator(medical, 20)
    ...
    paginator_recreation = Paginator(recreation, 20)
    ...
    unfiltered_qs = vbp_ct.objects.order_by('city', 'business_name')
...
def ny_list(request):
    data = request.GET
    print(data)
    f = StateFilter(data, queryset=vbp_ny.objects.order_by('city', 'business_name'))
    filtered_qs = f.qs
    print(f.qs)
    beauty = filtered_qs.filter(category='beauty').order_by('city', 'business_name')
    books = filtered_qs.filter(category='books').order_by('city', 'business_name')
    ...
    paginator_transportation = Paginator(transportation, 22)
    paginator_visual = Paginator(visual, 22)
    unfiltered_qs = vbp_ny.objects.order_by('city', 'business_name')
    print(filtered_qs)
    for object in filtered_qs:
        obj = object
        print(obj)
...
def nj_list(request):
    ...
    paginator_transportation = Paginator(transportation, 22)
    paginator_visual = Paginator(visual, 22)
    unfiltered_qs = vbp_nj.objects.order_by('city', 'business_name')
    for object in filtered_qs:
        obj = object
        paginator = Paginator(obj, 22)
        return render(request, 
...
def ma_list(request):
    ...
    paginator_transportation = Paginator(transportation, 22)
    paginator_visual = Paginator(visual, 22)
    unfiltered_qs = vbp_ma.objects.order_by('city', 'business_name')
    for object in filtered_qs:
        obj = object
        paginator = Paginator(obj, 22)
        return render(request, 
...
def va_list(request):
    ...
    paginator_transportation = Paginator(transportation, 22)
    paginator_visual = Paginator(visual, 22)
    unfiltered_qs = vbp_va.objects.order_by('city', 'business_name')
    for object in filtered_qs:
        obj = object
        paginator = Paginator(obj, 22)
        return render(request, 
...
def pa_list(request):
    ...
    paginator_transportation = Paginator(transportation, 22)
    paginator_visual = Paginator(visual, 22)
    unfiltered_qs = vbp_pa.objects.order_by('city', 'business_name')
    for object in filtered_qs:
        obj = object
        paginator = Paginator(obj, 22)
        return render(request, 
...
def dc_list(request):
    ...
    paginator_transportation = Paginator(transportation, 22)
    paginator_visual = Paginator(visual, 22)
    unfiltered_qs = vbp_dc.objects.order_by('city', 'business_name')
    for object in filtered_qs:
        obj = object
        paginator = Paginator(obj, 22)
        return render(request, 
...
def de_list(request):
    ...
    paginator_transportation = Paginator(transportation, 22)
    paginator_visual = Paginator(visual, 22)
    unfiltered_qs = vbp_de.objects.order_by('city', 'business_name')
    for object in filtered_qs:
        obj = object
        paginator = Paginator(obj, 22)
        return render(request, 
...
def getStateListings(request):
    ...
    if state == 'US-CT':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_ct.objects.order_by('city', 'business_name')),
    ...
    if state == 'US-DE':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_de.objects.all().order_by('city', 'business_name')),
    ...
    if state == 'US-MD':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_md.objects.all().order_by('city', 'business_name')),
    ...
    if state == 'US-MA':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_ma.objects.all().order_by('city', 'business_name')),
    ...
    if state == 'US-NJ':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_nj.objects.all().order_by('city', 'business_name')),
    ...
    if state == 'US-NY':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_ny.objects.all().order_by('city', 'business_name')),
    ...
    if state == 'US-OH':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_oh.objects.all().order_by('city', 'business_name')),
    ...
    if state == 'US-PA':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_pa.objects.all().order_by('city', 'business_name')),
    ...
    if state == 'US-VA':
        covers_qs = vbp_book.objects.all()
        state_qs = list(vbp_va.objects.all().order_by('city', 'business_name')),
