...
class BusinessForm(forms.Form):
    ...
    owner_name = forms.CharField(label='Name of Business Owner(s)', widget=TextInput(attrs={'class':'textfield'}), label_suffix='')
    years_in_business = forms.CharField(label="What is the # of years in business?", widget=forms.Select(choices=YEARS_IN_BUSINESS_CHOICES), label_suffix='')
    employees = forms.CharField(label="How many employees do you have?", widget=forms.Select(choices=EMPLOYEES_CHOICES), label_suffix='')
    revenue = forms.CharField(label="What is your estimated 2021 revenue", widget=forms.Select(choices=REVENUE_CHOICES), label_suffix='')
